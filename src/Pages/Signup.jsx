...
console.log( { fullname, email, password, confirmPassword, role })
    const result = await login({ fullname, email, password, confirmPassword, role });
    console.log(result); // Handle the result (user data or error) accordingly
  };
  ...
  return (
    <div className="border rounded-lg">
      ...
      <form className="card-body items-center text-center" onSubmit={submitHandler}>
